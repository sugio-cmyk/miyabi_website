...
| お悩み (TROUBLES) | 3カラム+2カラム（アイコン付き） | 共感・課題喚起 | 特徴へ |
| 選ばれる理由 | 3つの特徴（背景 #f0f4f8） | 差別化 | サービス詳細 |
| サービス紹介 | 3カラムカード（背景 #faf9f7） | サービス認知 | サービスページへ |
| CTA | 無料相談誘導 | コンバージョン | 問い合わせ |
| SEOエリアリスト | 香川県全市町村名 | ローカルSEO | - |
...
| エリア | 内容 | 備考 |
|--------|------|------|
| 左 (Area 1) | 事務所情報、プライバシーポリシー | - |
| 中央 (Area 2) | 信頼性情報（資格、エリア、無料相談等） | - |
| 右 (Area 3) | お問い合わせ情報（TEL, Mail, 営業時間） | - |

> ※フッターナビゲーションメニューは廃止し、ウィジェットに統合。
